...
SECRET_KEY = 'django-insecure-wn*^45(fk$j2n5@$w*8*@g%bxyjq3-f2fm!(3@-(*iv-xs@9=s'
...
ROOT_URLCONF = 'srvSIGEM.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'templates'],  # Ruta global, no una app específica
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'srvSIGEM.wsgi.application'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [BASE_DIR / 'appSIGEM' / 'static']
